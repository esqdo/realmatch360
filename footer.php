...
<footer class="container" id="footer" role="contentinfo">
    <div id="copyright">
<p>&copy;<?php echo date(' Y '); ?> Immo Marktdaten AG</p>
</div>
    
    <div id="footernav" class="grid_12"><?php wp_nav_menu( array( 'theme_location' => 'footer_menu' ) ); ?></div>
<script>jQuery( document ).ready(function( $ ) { app.init(); });</script>
<ul class="social-media grid_12">
